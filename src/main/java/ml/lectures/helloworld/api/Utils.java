...
//            for (int j = 0; j < weights.hsize(0); j++) {
...
//        val metrics = weights.metrics();
//        val nested = weights.nested();
//        for (int i = 0; i < metrics.isize(); i++) {
//            for (int j = 0; j < metrics.hsize(0); j++) {
//                nested.i2h(i, j, random());
//            }
//        }
//
//        for (int i = 0; i < metrics.hsize(); i++) {
//            for (int j = 0; j < metrics.hsize(i); j++) {
//                nested.b2h(i, j, random());
//            }
//        }
//
//        for (int i = 0; i < metrics.osize(); i++) {
//            for (int j = 0; j < metrics.hsize(metrics.hsize() - 1); j++) {
//                nested.h2o(j, i, random());
//            }
//        }
...
//        out.println(buf.toString());
    ...
    public static void randomizeWeights(final Weights1d weights) {
        ...
        for (int i = 0; i < metrics.hwidth(); i++) {
            for (int j = 0; j < metrics.hsize(i); j++) {
                nested.b2h(i, j, random());
            }
        }
        ...
        for (int i = 0; i < metrics.osize(); i++) {
            for (int j = 0; j < metrics.hsize(metrics.hwidth() - 1); j++) {
                nested.h2o(j, i, random());
            }
        }
    }
